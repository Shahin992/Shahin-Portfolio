...
const Skills = () => {
    ...
    return (
        <div id="skills">
           <div data-aos="zoom-out-up" className="max-w-[1100px] mx-auto my-10">
          ...
          <div  className="grid grid-cols-2 gap-10  justify-center items-center ">
                {
                    skill.map((data,index)=> <div data-aos="zoom-in" key={index}>
                       <div  className="bg-slate-100 w-[450px]  rounded-2xl p-5 h-44 ">
